...
an array. In a second step the numbers "0" or "1" are displayed on each position. The object used for the inside-test consists of two letters: "IT".
*/ 
...
#declare Ortho = camera {
    ...
    look_at  <0,1,0>
    right 16*x            // horizontal size of view
    up 9*y               // vertical size of view
}
...
#declare Eins = text {
   ...
   "arial.ttf",  // Microsoft Windows-format TrueType font file name
    ...
    scale <0.35, 0.35, 0.35>
    pigment {
        color rgb <0,0,0>     // solid color pigment
    }
// control an object's surface finish
    finish {
        ambient 0.3          // ambient surface reflection color [0.1]
...
xyzDistributionInsideArray (Huelle, <-4.2, -3.1, -1.3>, 40, 30, 10, 0.35, 0.35, 0.35, 1)
